...
public class ahorcadoController {
    ...
    public void initialize() {
        ...
        preguntaImagen1 = seleccionarImagen();
        imagen1.setImage(preguntaImagen1);
        intentosRestantes = 7;
    ...
    private Image seleccionarImagen() {
    	int i = indi;
		Image image = new Image("file:///C:/Users/User/Desktop/Eclipse/The_Kids_Battle/src/application/ahorcado1" + i + ".jpg");
		return image;
    ...
    private void segundoahorcado() throws IOException {
    	        ...
    	        secondStage.setTitle("Ahorcado: Pregunta 2");
    	        secondStage.setScene(new Scene(root));
    	        secondStage.show();
    	    
    }
    
    private void bienveAhorcado() throws IOException{
    	Stage secondStage = new Stage(); 
