...
public class ahorcado2Controller {
    ...
    public void initialize() {
        ...
        preguntaImagen2 = seleccionarImagen();
        imagen2.setImage(preguntaImagen2);
   ...
   private Image seleccionarImagen() {
   	int i = indi2;
		Image image = new Image("file:///C:/Users/User/Desktop/Eclipse/The_Kids_Battle/src/application/ahorcado2" + i + ".jpg");
		return image;
    ...
    private void tercerahorcado() throws IOException {
    	        ...
    	        secondStage.setTitle("Ahorcado: Pregunta 3");
